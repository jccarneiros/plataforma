            ...
            <div class="card-header">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('administrators.secretariats.index')}}">Secretaria</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Secretaria bloqueados</li>
                    </ol>
                </nav>
            </div>
            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tableIndex" class="table table-hover table-sm table-bordered"
                                        ...
                                        @forelse($secretariats as $secretariat)
                                            <tbody>
                                            <tr>
                                                <td class="text-truncate">{{$secretariat->code}}</td>
                                                <td class="text-truncate">{{$secretariat->name}}</td>
                                                <td class="text-truncate">{{$secretariat->email}}</td>
                                                <td class="text-truncate">{{Carbon\Carbon::parse($secretariat->created_at)->format('d/m/Y')}}</td>
                                                <td class="text-truncate text-center">
                                                    @can('supervisions.restore')
                                                        <a data-bs-toggle="modal"
                                                           data-bs-target="#{{ 'modal_Restore' . $secretariat->id }}"
                                                ...
                                                <td class="text-center">
                                                    @can('supervisions.forceDelete')
                                                        <a data-bs-toggle="modal"
                                                           data-bs-target="#{{ 'modal_ForceDelete'. $secretariat->id }}"
                                            ...
                                            @include('administrators::secretariats.modals.restore', ['secretariat' => $secretariat])
                                            @include('administrators::secretariats.modals.force-delete', ['secretariat' => $secretariat])
                                        @empty
