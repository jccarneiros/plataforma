<form action="{{route('administrators.supervisors.delete', $supervisor->id)}}" method="POST">
    @csrf
    @method('DELETE')
    <div id="{{ 'modal_Delete' . $supervisor->id  }}" class="modal fade" data-keyboard="false" data-backdrop="static">
