<form action="{{route('administrators.managements.delete', $management->id)}}" method="POST">
    @csrf
    @method('DELETE')
    <div id="{{ 'modal_Delete' . $management->id  }}" class="modal fade" data-keyboard="false" data-backdrop="static">
