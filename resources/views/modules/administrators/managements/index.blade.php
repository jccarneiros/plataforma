            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-3">
                        @include('administrators::managements.includes.import-management')
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                            <a href="{{route('administrators.managements.allTrashed')}}"
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                        @include('administrators::managements.create')
                        <div class="row">
                                    ...
                                    <table class="table table-sm table-hover table-bordered">
                                        ...
                                        @forelse($managements as $management)
                                            <tr>
                                                ...
                                                <td>
                                                    @include('administrators::managements.includes.update-role')
                                                </td>
                                                <td>
                                                    @include('administrators::managements.includes.update-active')
                                                </td>
                                                <td class="text-truncate text-center">
                                                    <a href="{{route('administrators.managements.edit', $management->id)}}"
                                                ...
                                                <td class="text-center">
                                                    <a data-bs-toggle="modal"
                                                       data-bs-target="#{{ 'modal_Delete' . $management->id }}"
                                                       class="btn btn-sm btn-danger w-100">Bloquear
                                                    </a>
                                                </td>
                                            </tr>
                                            @include('administrators::managements.modals.delete', ['management' => $management])
                                        @empty
