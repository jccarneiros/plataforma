                ...
                <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Coordenadores</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-3">
                        @include('administrators::coordinators.includes.import-coordinator')
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                            <a href="{{route('administrators.coordinators.allTrashed')}}"
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                        @include('administrators::coordinators.create')
                        <div class="row">
                                    ...
                                    <table class="table table-sm table-hover table-bordered">
                                        ...
                                        @forelse($coordinators as $coordinator)
                                            <tr>
                                                ...
                                                <td>
                                                    @include('administrators::coordinators.includes.update-role')
                                                </td>
                                                <td>
                                                    @include('administrators::coordinators.includes.update-active')
                                                </td>
                                                <td class="text-truncate text-center">
                                                    <a href="{{route('administrators.coordinators.edit', $coordinator->id)}}"
                                                ...
                                                <td class="text-center">
                                                    <a data-bs-toggle="modal"
                                                       data-bs-target="#{{ 'modal_Delete' . $coordinator->id }}"
                                                       class="btn btn-sm btn-danger w-100">Bloquear
                                                    </a>
                                                </td>
                                            </tr>
                                            @include('administrators::coordinators.modals.delete', ['coordinator' => $coordinator])
                                        @empty
