            ...
            <div class="card-header">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('administrators.teachers.index')}}">Professores</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Professores bloqueados</li>
                    </ol>
                </nav>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                        ...
                        <div class="border border-1 p-3">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                                <a href="{{route('administrators.teachers.index')}}"
                                ...
                                <div class="table-responsive">
                                    <table id="tableIndex" class="table table-hover table-sm table-bordered"
                                        ...
                                        @forelse($teachers as $teacher)
                                            <tbody>
                                            <tr>
                                                <td class="text-truncate">{{$teacher->code}}</td>
                                                <td class="text-truncate">{{$teacher->name}}</td>
                                                <td class="text-truncate">{{$teacher->email}}</td>
                                                <td class="text-truncate">{{Carbon\Carbon::parse($teacher->created_at)->format('d/m/Y')}}</td>
                                                <td class="text-truncate text-center">
                                                    @can('supervisions.restore')
                                                        <a data-bs-toggle="modal"
                                                           data-bs-target="#{{ 'modal_Restore' . $teacher->id }}"
                                                ...
                                                <td class="text-center">
                                                    @can('supervisions.forceDelete')
                                                        <a data-bs-toggle="modal"
                                                           data-bs-target="#{{ 'modal_ForceDelete'. $teacher->id }}"
                                            ...
                                            @include('administrators::teachers.modals.restore', ['teacher' => $teacher])
                                            @include('administrators::teachers.modals.force-delete', ['teacher' => $teacher])
                                        @empty
