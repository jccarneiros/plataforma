<form action="{{route('administrators.teachers.restore', $teacher->id)}}" method="POST">
    @csrf
    <div id="{{ 'modal_Restore' . $teacher->id  }}" class="modal fade" data-keyboard="false" data-backdrop="static">
