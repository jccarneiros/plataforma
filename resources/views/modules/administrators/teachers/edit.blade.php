...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <h6 class="with-line left">Editar: {{$teacher->name}}</h6>
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                <form action="{{route('administrators.teachers.updateAvatar', $teacher->id)}}" method="POST"
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 text-center">
                                @if($teacher->avatar != "")
                                    <img src="{{url('/assets/uploads/images/users/'.$teacher->avatar)}}"
                                         alt="{{$teacher->name}}" class="flex-shrink-0 me-2 rounded" width="200"
                                         height="150">
                                @endif
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                <form action="{{route('administrators.teachers.update', $teacher->id)}}" method="POST"
                      enctype="multipart/form-data">
                    @csrf
                    <input name="_method" type="hidden" value="PUT">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 mb-3">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                                <input type="text" name="name" value="{{$teacher->name, old('name')}}"
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                                <input type="email" name="email" value="{{$teacher->email, old('email')}}"
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-3">
                            @include('administrators::teachers.includes.edit-roles', ['teacher' => $teacher])
                        </div>
