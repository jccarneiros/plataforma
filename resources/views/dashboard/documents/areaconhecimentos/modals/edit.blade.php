@can('areaconhecimentos.edit')
    <div class="modal fade" id="{{ 'modal_Edit_AreaConhecimento' . $item->id  }}" tabindex="-1" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('dashboard.areaconhecimentos.update', $item->id)}}" method="POST">
                    @method('PUT')
                    @csrf
