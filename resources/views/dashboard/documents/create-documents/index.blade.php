            ...
            <div class="card-header">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$user->areaConhecimento->name}}</li>
                    </ol>
                </nav>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <table class="table table-sm table-bordered table-hover">
                            ...
                            @forelse ($documentTypes as $documentType)
                                <tr>
                                    <td class="text-truncate">{{$documentType->name}}</td>
                                    <td class="text-truncate">{{$documentType->periodicidade}}</td>
                                    <td class="text-truncate text-center">
                                            <a href="{{route('dashboard.documents.documentType', [$documentType->id])}}"
                                               class="btn btn-sm btn-info">
                                                Gerenciar <span class="badge bg-secondary">{{$documentType->documentPeriods->count()}}</span>
                                            </a>
                                    </td>
