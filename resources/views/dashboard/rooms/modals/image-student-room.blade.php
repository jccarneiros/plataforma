<div class="modal fade" id="imageStudentRoom{{$student->id}}" tabindex="-1" aria-labelledby="userModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: rgb(52, 73, 94) !important;color: #cccccc!important;">
            ...
            <div class="modal-body text-center">
                ...
                <div class="mb-3">
                    <span>Turma: {{$student->room->name}} | RA: {{$student->number_ra}} |
                        Dígito: {{$student->number_ra_digit}} |  Idade: {{\Carbon\Carbon::parse($student->date_birth)->age}}</span>
                </div>
                <div class="mb-3">
                    <span>{{$student->email_microsoft}}</span>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    @if($student->clube)
                        Clube: {{$student->clube->president->sala->name}}
                    @else
                ...
                <div class="mb-3">
                    @if($student->clube)
                        Presidente do clube: {{$student->clube->president->user->name}}
                    @endif
                </div>
            </div>
