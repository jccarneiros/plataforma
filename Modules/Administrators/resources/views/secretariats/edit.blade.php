...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <h6 class="with-line left">Editar: {{$secretariat->name}}</h6>
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                <form action="{{route('administrators.secretariats.updateAvatar', $secretariat->id)}}" method="POST"
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 text-center">
                                @if($secretariat->avatar != "")
                                    <img src="{{url('/assets/uploads/images/users/'.$secretariat->avatar)}}"
                                         alt="{{$secretariat->name}}" class="flex-shrink-0 me-2 rounded" width="200"
                                         height="150">
                                @endif
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                <form action="{{route('administrators.secretariats.update', $secretariat->id)}}" method="POST"
                      enctype="multipart/form-data">
                    @csrf
                    <input name="_method" type="hidden" value="PUT">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 mb-3">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                                <input type="text" name="name" value="{{$secretariat->name, old('name')}}"
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                                <input type="email" name="email" value="{{$secretariat->email, old('email')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg col-xl mb-3">
                                    <a href="{{route('administrators.secretariats.index')}}"
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-3">
                            @include('administrators::secretariats.includes.edit-roles', ['secretariat' => $secretariat])
                        </div>
