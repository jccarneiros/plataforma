<form action="{{route('administrators.coordinators.delete', $coordinator->id)}}" method="POST">
    @csrf
    @method('DELETE')
    <div id="{{ 'modal_Delete' . $coordinator->id  }}" class="modal fade" data-keyboard="false" data-backdrop="static">
