<form action="{{route('administrators.teachers.delete', $teacher->id)}}" method="POST">
    @csrf
    @method('DELETE')
    <div id="{{ 'modal_Delete' . $teacher->id  }}" class="modal fade" data-keyboard="false" data-backdrop="static">
