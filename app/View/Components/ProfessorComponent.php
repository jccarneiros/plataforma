...
class ProfessorComponent extends Component
{
    ...
    public function render(): View|Closure|string
    {
        ...
        return view('components.professors.professor-component', compact('professors', 'salas','users'));
    }
...
//            $this->message->storeSuccess();
    ...
    public function eletivas($id)
    {
        ...
        return view('components.professors.eletivas', compact('professor', 'salas','users','students', 'eletivas'));
    }
...
//        dd($eletivas);
        $pdf = PDF::loadView('components.professors.pdf-professor-students', compact('professor', 'eletivas'));
