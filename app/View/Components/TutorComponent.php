...
class TutorComponent extends Component
{
    ...
    public function render(): View|Closure|string
    {
        ...
        return view('components.tutors.tutor-component', compact('tutores', 'salas', 'users'));
    }
...
//            $this->message->storeSuccess();
    ...
    public function tutorias($id)
    {
        ...
        $tutorias = Tutoria::with('tutor', 'student')->where('tutor_id', '=', $tutor->id)->get();
        ...
        return view('components.tutors.tutorias', compact('tutor', 'salas', 'users', 'students', 'tutorias'));
    }
...
//            $this->message->updateSuccess();
    ...
    public function updateStatusTutor($id)
    {
        $item = $this->repository::find($id);
...
//            $this->message->updateSuccess();
    ...
    public function updateLimitTutor($id)
    {
        $item = $this->repository::find($id);
...
//            $this->message->updateSuccess();
    ...
    public function studentsTutoriaPdf($id)
    {
...
//        dd($tutorias);
        $pdf = PDF::loadView('components.tutors.pdf-tutor-students', compact('tutor', 'tutorias'));
