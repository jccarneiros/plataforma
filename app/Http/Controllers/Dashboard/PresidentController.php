...
class PresidentController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('dashboard.presidents.index', compact('presidents', 'salas','users'));
    }
...
//            $this->message->storeSuccess();
    ...
    public function clubes($id)
    {
        ...
        return view('dashboard.presidents.clubes', compact('president', 'salas','users','students', 'clubes'));
    }
...
//        dd($clubes);
        $pdf = PDF::loadView('dashboard.presidents.pdf-president-students', compact('president', 'clubes'));
