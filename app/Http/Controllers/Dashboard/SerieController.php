...
class SerieController extends Controller
{
    ...
    public function index():View
    {
        ...
        $data = SeriesRepository::getSeries(['tipoEnsino', 'rooms', 'students'],  'tipo_ensino_id', 'asc', 'type', 'desc');

        return view('dashboard.series.index', compact('data', 'tipoEnsinos'));
    }
    ...
    public function rooms($serie): View
    {
        ...
        return view('dashboard.rooms.index', compact('serie', 'tipoEnsinos', 'arrayRoom'));
    }
}
